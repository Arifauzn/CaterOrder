			...
			<div class="top-nav">
				<div class="top-nav-left">
					<ul>
						...
						<li><a href="status_tracker.php" style="text-decoration:none;">Status tracker</a></li>
						<div class="clear"> </div>
					</ul>
				</div>
				<div class="clear"> </div>
    ...
    $datetime = mysqli_real_escape_string($link, $_POST['datetime']);
        ...
        $sql = "INSERT INTO sh_order(sh_fullname, sh_email, sh_mobile, sh_companyname, sh_budget, sh_people, sh_function, sh_menu, sh_service, sh_detailsvenue, sh_addressvenue, sh_datetime) VALUES ('$fullname', '$email', '$mobile', '$company', '$budget', '$people', '$function', '$menu', '$service', '$detailsvenue', '$addressvenue', '$datetime')";
            ...
            if($reg > 0)
            {
				...
				echo "<script> setTimeout(function() { window.location.href = 'checkout.php?order_id={$order_id}';}, 1500);</script>";
            }
            else
            {
				  ...
				  <div class="contact-form">
				  	<h3>Preferences</h3>
					    	<div>
                                ...
                                <span><input class="textbox" type="text" name="budget" placeholder="RM" required></span>
						    </div>
						    <div>
